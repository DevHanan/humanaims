...
<div class="form-group  col-md-12">
    <label for="formInputPermissions"> {{__('back.Lines')}} </label>
    {{ Form::select('lines[]', $line->all()->pluck('name', 'id')->toArray(), null,['class'=>'select2 ',disable_on_show(),'autocomplete'=>"off"  , 'multiple'=> 'multiple']) }}
    {{input_error($errors,'lines')}}
</div>
