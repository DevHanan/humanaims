...
{{-- scripts --}}
<script src="{{ asset('assets/website/js/font.awesome.min.js') }}"></script>
<script src="{{ asset('assets/website/js/autosize.js') }}"></script>
...
<link href="{{ asset('assets/website/css/'.$dark_mode.'.mode.css') }}" rel="stylesheet" />
<link href="{{ asset('assets/website/css/app.css') }}" rel="stylesheet" />

{{-- Messenger Color Style--}}
@include('website.messages.layouts.messengerColor')
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-body">
           ...
           <div class="@if($route == 'user') show @endif messenger-tab app-scroll" data-view="users">
               ...
               {{-- Saved Messages --}}
               {!! view('website.messages.layouts.listItem', ['get' => 'saved','id' => $id])->render() !!}
...
@include('website.messages.layouts.modals')
@include('website.messages.layouts.footerLinks')
